...
namespace BC_House_ASP.Interface
{
    ...
    {
        void AddKlant(string klantNaam, string klantEmail, int telefoonNummer, string klantPassword, string postcode, string huisNummer, string straat, string woonplaats);
